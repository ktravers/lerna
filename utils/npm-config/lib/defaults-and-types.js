...
/*
 * woo copypaste of https://github.com/npm/cli/blob/2a80c67e/lib/utils/config.js
 * (with auto-formatting and some manual edits, lol)
 */
...
const editor = process.env.EDITOR || process.env.VISUAL || (isWindows ? "notepad.exe" : "vi");
...
// NOPE, not using nopt(), so shorthands are irrelevant
/*
const shorthands = {
  "?": ["--usage"],
  a: ["--all"],
